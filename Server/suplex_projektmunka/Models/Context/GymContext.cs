// ── ADD TO GymContext.cs ──────────────────────────────────────────────────────
//
// 1. Add this DbSet property alongside the others:
//
//    public DbSet<Discount> Discounts { get; set; } = null!;
//
// 2. Inside OnModelCreating(), add the relationship:
//
//    // Item -> Discounts (1-to-many)
//    modelBuilder.Entity<Item>()
//        .HasMany<Discount>()
//        .WithOne(d => d.Item)
//        .HasForeignKey(d => d.Item_id);
//
// ── FULL UPDATED GymContext.cs ────────────────────────────────────────────────
...
namespace suplex_projektmunka.Models.Context
{
    public class GymContext : DbContext
    {
        ...
        public DbSet<Discount> Discounts { get; set; } = null!;   // NEW
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Item>().HasData(
                new Item { Id = 1, Name = "Napijegy", Description = "Teljes hozzáférés egy napra. Nincs kötelezettség.", ImagePath = null, Price = 2900, Type_id = 1, ValidityDays = 1, IsActive = true, CreatedAt = new DateTime(2026, 1, 1), ModifiedAt = new DateTime(2026, 1, 1) },
                new Item { Id = 2, Name = "Havi bérlet", Description = "Korlátlan hozzáférés 30 napra. Részt vehetsz az összes csoportos edzésen.", ImagePath = null, Price = 12900, Type_id = 2, ValidityDays = 30, IsActive = true, CreatedAt = new DateTime(2026, 1, 1), ModifiedAt = new DateTime(2026, 1, 1) },
                new Item { Id = 3, Name = "Szezonális bérlet", Description = "90 nap korlátlan hozzáférés. Kiváló választás elkötelezett edzeni vágyóknak.", ImagePath = null, Price = 32900, Type_id = 4, ValidityDays = 90, IsActive = true, CreatedAt = new DateTime(2026, 1, 1), ModifiedAt = new DateTime(2026, 1, 1) },
                new Item { Id = 4, Name = "Éves bérlet", Description = "Legjobb ár-érték arány – teljes hozzáférés 365 napra.", ImagePath = null, Price = 99900, Type_id = 3, ValidityDays = 365, IsActive = true, CreatedAt = new DateTime(2026, 1, 1), ModifiedAt = new DateTime(2026, 1, 1) }
            );
            ...
            modelBuilder.Entity<User>().HasData(
                new User { Id = 1, Name = "Suplex Admin", Username = "admin", Email = "admin@suplexgym.hu", PasswordHash = "$2a$11$k7a2vkvbZMmodCBgocWMAeS7Ys6rubYQLMpogAZkdi50JftM6zCPq", Role_id = 1, Settings_id = 1, IsActive = true, CreatedAt = new DateTime(2026, 1, 1), ModifiedAt = new DateTime(2026, 1, 1) },
                new User { Id = 2, Name = "Kovács Péter", Username = "kpeter", Email = "peter@suplexgym.hu", PasswordHash = "$2b$11$pkOPLWmS/dgVTR6CKSiePupIjHvBoRMaklmm0mCItpDSSlqJ6FYEW", Role_id = 3, Settings_id = 2, IsActive = true, CreatedAt = new DateTime(2026, 1, 1), ModifiedAt = new DateTime(2026, 1, 1) },
                new User { Id = 3, Name = "Nagy Anna", Username = "nanna", Email = "anna@gmail.com", PasswordHash = "$2b$11$sfOyEWXVYffY0c.4sGXyZudGuKQl//zIGmVU.2sYz2sD.zuwXoCSm", Role_id = 2, Settings_id = 3, IsActive = true, CreatedAt = new DateTime(2026, 1, 1), ModifiedAt = new DateTime(2026, 1, 1) }
            );

            modelBuilder.Entity<News>().HasData(
                new News { Id = 1, Title = "Megnyitottunk!", ImagePath = "", Content = "Örömmel jelentjük be, hogy a Suplex Gym hivatalosan is megnyitotta kapuit! Korszerű gépparkunk, tágas öltözőink és tapasztalt edzőink várják az edzeni vágyókat hétfőtől szombatig 6:00-tól 22:00-ig. Látogass el hozzánk és próbáld ki az első edzést ingyen!", IsActive = true, CreatedAt = new DateTime(2026, 1, 10), ModifiedAt = new DateTime(2026, 1, 10) },
                new News { Id = 2, Title = "Új csoportos edzések", ImagePath = "", Content = "Februártól bővítjük csoportos óráink kínálatát! Hetente háromszor tartunk spinning, jóga és HIIT edzést is. A bérletes tagoknak az összes csoportos óra ingyenes. Időpontok és helyek korlátozottak, előre foglalás ajánlott az edzőknél.", IsActive = true, CreatedAt = new DateTime(2026, 2, 1), ModifiedAt = new DateTime(2026, 2, 1) },
                new News { Id = 3, Title = "Tavaszi akció – 20% kedvezmény", ImagePath = "", Content = "Március 15-től április 30-ig minden új bérlet vásárlásakor 20% kedvezményt adunk! Ez vonatkozik a havi, szezonális és éves bérletekre egyaránt. Ne hagyd ki – ez az ajánlatunk korlátozott ideig él. Vásárold meg most az alkalmazáson keresztül!", IsActive = true, CreatedAt = new DateTime(2026, 3, 15), ModifiedAt = new DateTime(2026, 3, 15) },
                new News { Id = 4, Title = "Diák- és nyugdíjasakció", ImagePath = "", Content = "Tudjuk, mennyire fontos a mozgás minden életszakaszban. Diákok és nyugdíjasok érvényes igazolvánnyal 30%-os kedvezménnyel vásárolhatnak bérletet a recepción. A mozgás mindenkinek jár – segítünk abban, hogy elérhető legyen számodra is.", IsActive = true, CreatedAt = new DateTime(2026, 4, 1), ModifiedAt = new DateTime(2026, 4, 1) },
                new News { Id = 5, Title = "Karbantartási szünet", ImagePath = "", Content = "Tájékoztatjuk tagjainkat, hogy április 28-án (hétfőn) reggel 6:00 és 10:00 között technikai karbantartás miatt zárva tartunk. A szünet alatt új futópadokat és szabad súlyos eszközöket helyezünk üzembe. Elnézést kérünk az esetleges kellemetlenségekért!", IsActive = true, CreatedAt = new DateTime(2026, 4, 20), ModifiedAt = new DateTime(2026, 4, 20) }
            );

...
export default function NewsListScreen() {
  ...
  const { items, refetchItems } = useRestApi<NewsDTO>("/news");
  ...
  //       </View>
  // );
  const renderItem = (info: ListRenderItemInfo<NewsListScreenItem>) => {
    const item = info.item;
    return (
      <TouchableOpacity className="flex-1 flex-row h-28">

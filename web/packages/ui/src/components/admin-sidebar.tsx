...
export function AdminSidebar({
  ...
  const allNavItems: NavItem[] = [
    ...
    {
      title: t("admin.sections.discounts"),
      section: "discounts",
  ...
  return (
    <Sidebar variant="inset" {...props}>
            ...
            <SidebarMenuButton size="lg" variant="outline" asChild>
              <a onClick={() => (window.location.href = "/")}>
                ...
                <div className="flex w-7/12 gap-0.5 leading-none">
                  <span className="text-[11px] leading-none font-semibold tracking-[0.2em] text-foreground/90 uppercase">
                    Suplex Gym
                  </span>
                </div>
      ...
      <SidebarFooter>
        <div className="mb-6 flex w-full items-center justify-center gap-1 px-1">
          <ModeToggle />
          <Logout />
          <Language />
        </div>

...
export default function BlogContentLimited() {
  ...
  return (
    <section className="py-16">
      <h2 className="m-6 text-2xl !leading-tight font-semibold tracking-tight [text-wrap:_balance] md:text-3xl lg:text-4xl">
        Latest news
      </h2>
      <div className="container mx-auto grid grid-cols-1 items-start gap-6 md:grid-cols-2 lg:grid-cols-3">
        {posts.slice(0, 3).map(({ imagePath, title, content, createdAt }) => (
          <Drawer direction="bottom">
            <DrawerTrigger>
              <Card key={title} className="m-4 overflow-hidden py-0">

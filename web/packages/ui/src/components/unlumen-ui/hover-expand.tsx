            ...
            >
              ...
              >
                <img
                  src={item.image}
                  alt={item.imageAlt ?? ""}
                  className="h-full w-full rounded-md border border-current/20 object-cover"
                  loading="lazy"
                  decoding="async"
                />
                <div className="absolute inset-0 rounded-md bg-linear-to-t from-black/70 via-black/20 to-black/10" />
              </motion.div>
              ...
              <div className="absolute inset-0 flex items-end px-5 pb-4">
                <div className="flex w-full items-end justify-between gap-4">
                  <div className="flex min-w-0 items-baseline gap-3">
                    ...
                    {item.description && (
                      <motion.span
                        className="hidden text-sm text-white/70 sm:block"

...
export const API_ENDPOINTS = {
  ...
  get upload() {
    return `${getCachedApiBase()}/api/upload`
  },
  // Admin
  get adminUsers() {
    return `${getCachedApiBase()}/api/admin/users`
  },
  get adminRoles() {
    return `${getCachedApiBase()}/api/admin/roles`
  },
  get adminItems() {
    return `${getCachedApiBase()}/api/admin/items`
  },
  get adminEquipment() {
    return `${getCachedApiBase()}/api/admin/equipment`
  },
  // Discounts & Deals
  get deals() {
  ...
  get adminDeals() {
    return `${getCachedApiBase()}/api/admin/deals`
  },
}
